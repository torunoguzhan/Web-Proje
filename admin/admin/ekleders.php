                ...
                <div class="x_content">
                  ...
                  <div class="form-group">
                    <form action="../../islem.php" method="POST">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ders programı linki <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <button style="margin-top:10px"  name="dersprogramekle" type="submit" class="btn btn-success">Ekle</button>
                      </div>
                    </form>
                  </div>
                </div>
